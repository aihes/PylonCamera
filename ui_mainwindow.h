...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        centralWidget->setMinimumSize(QSize(684, 520));
        centralWidget->setMaximumSize(QSize(1120, 520));
        ...
        layoutWidget->setGeometry(QRect(0, 0, 661, 491));
        ...
        destDisplay = new QLabel(srcFrame);
        destDisplay->setObjectName(QStringLiteral("destDisplay"));
        destDisplay->setGeometry(QRect(660, 30, 381, 331));

        horizontalLayout->addWidget(srcFrame);
